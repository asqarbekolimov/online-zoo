    ...
    <section className="live-cams">
      <div className="container">
        <div className="top-text">
          ...
          <button className="btn donation-trigger"  onClick={()=>setOpenModal(true)}>
              ...
              <ul className="cam__list">
                <li className="cam_item cam_item--active">
                  <a href="#" className="cam__card">
                    ...
                    <img src={`/assets/images/card/${animal.id}.png`} alt="panda 1" />
                    <button className="play_btn"></button>
                  </a>
                </li>
                <li className="cam_item">
                  <a href="#" className="cam__card">
                    ...
                    <img src={`/assets/images/card/${animal.id}.png`} alt="panda 2" />
                    <button className="play_btn"></button>
                  </a>
                </li>
                <li className="cam_item">
                  <a href="#" className="cam__card">
                    ...
                    <img src={`/assets/images/card/${animal.id}.png`} alt={animal.commonName} />
                    <button className="play_btn"></button>
                  </a>
                </li>
              </ul>
